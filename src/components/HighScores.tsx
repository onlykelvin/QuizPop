...
export function HighScores() {
  ...
  const shareText = `🏆 My top score in QuizPop: ${topScore.score}/${topScore.total} (${Math.round((topScore.score / topScore.total) * 100)}%) in ${topScore.category}! Can you beat it?`;
    ...
    <div className="max-w-3xl mx-auto px-4 mt-12">
      <div className="bg-white rounded-2xl shadow-xl p-8" style={{ marginBottom: '2rem' }}>
        <div className="flex items-center justify-between mb-6">
          ...
          <ShareButton text={shareText} showText={t('stats.actions.share')} />
        </div>
