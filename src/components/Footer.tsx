        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://github.com/onlykelvin/QuizPop" className="flex items-center gap-2 text-gray-600 hover:text-purple-600 transition-colors">
                  <Github className="w-4 h-4" />
                  <span>GitHub</span>
                </a>
              </li>
              <li>
                <a href="https://www.kelvincdeen.nl" className="flex items-center gap-2 text-gray-600 hover:text-purple-600 transition-colors">
                  <Globe className="w-4 h-4" />
                  <span>www.kelvincdeen.nl</span>
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/kelvincdeen" className="flex items-center gap-2 text-gray-600 hover:text-purple-600 transition-colors">
